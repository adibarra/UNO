...
public class Tracker
{
	...
	public static ArrayList<Animator> effects = new ArrayList<Animator>();
	...
	public static void prepare()
	{
		...
		hands.add(Logic.comp1Hand);
		hands.add(Logic.comp2Hand);
		hands.add(Logic.comp3Hand);
	}
		...
		for(int k = 0; k < hands.size(); k++)
		{
			...
			else if(hands.get(k).equals(Logic.comp1Hand))
			{
				...
				{			
					...
					effects.add(new Animator(5000,"Computer 1 has won!"));
					break;
				}
			} 
			else if(hands.get(k).equals(Logic.comp2Hand))
			{
				if(Logic.comp2Hand.checkForWin())
				{
					...
					effects.add(new Animator(5000,"Computer 2 has won!"));
					break;
				}
			}
			else if(hands.get(k).equals(Logic.comp3Hand))
			{
				if(Logic.comp3Hand.checkForWin())
				{
					...
					effects.add(new Animator(5000,"Computer 3 has won!"));
					break;
				}
			}
		}
